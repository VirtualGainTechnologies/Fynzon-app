...
class BTCModel {
  ...
  BTCModel({this.message, this.error, this.data});
...
class MarketBTC extends StatefulWidget {
  @override
  _MarketBTCState createState() => _MarketBTCState();
}

class _MarketBTCState extends State<MarketBTC> {
  BTCModel fetchModal;
  ...
  fetchInr() async {
    ...
    var apiData = {"url": AuthToken.api + "/" + "v2/market/?baseCurrency=BTC",
      // "data": data
    };
    ApiClass.getApiCall(apiData, (onSuccess) {
      print(onSuccess.toString());
      fetchModal = BTCModel.fromJson(jsonDecode(onSuccess['response']));
