...
class UpdateNewBank extends StatefulWidget {
  const UpdateNewBank({Key key}) : super(key: key);

  @override
  _UpdateNewBankState createState() => _UpdateNewBankState();
}

class _UpdateNewBankState extends State<UpdateNewBank> {
  ...
  get_User()async{
    ...
    if(error == "true"){
      ...
      bankNameController.text = record['bank_name'];
      accController.text = record['bankAccNo'];
      reaccController.text = record['bankAccNo'];
      ifscController.text = record['ifscCode'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBar('Bank Info Update'),
      body: Form(
        key: _formKey,
