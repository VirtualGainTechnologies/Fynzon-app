...
class USDTWalletQRCode extends StatefulWidget {
  @override
  _USDTWalletQRCodeState createState() => _USDTWalletQRCodeState();
}

class _USDTWalletQRCodeState extends State<USDTWalletQRCode> {
  ...
  fetchAlbum() async {
    ...
    var apiData = {
      "url":
      AuthToken.api+"/"+"getQRcodeUSDT/"+AuthToken.authtoken+"/"+AuthToken.userid,
      //"data": data
    };
