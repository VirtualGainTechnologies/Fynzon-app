...
class ETHWalletQRCode extends StatefulWidget {
  @override
  _ETHWalletQRCodeState createState() => _ETHWalletQRCodeState();
}

class _ETHWalletQRCodeState extends State<ETHWalletQRCode> {
  ...
  fetchAlbum() async {
    ...
    var apiData = {
      "url":
      AuthToken.api+"/"+"getQRcodeETH/"+AuthToken.authtoken+"/"+AuthToken.userid,
      //"data": data
    };
        ...
        child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                child: Image.asset("./assets/images/fz_eth.png",scale: 7,),
              ),
