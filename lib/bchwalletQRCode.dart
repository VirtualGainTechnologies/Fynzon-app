...
class BCHWalletQRCode extends StatefulWidget {
  @override
  _BCHWalletQRCodeState createState() => _BCHWalletQRCodeState();
}

class _BCHWalletQRCodeState extends State<BCHWalletQRCode> {
  ...
  fetchAlbum() async {
    ...
    var apiData = {
      "url":
      AuthToken.api+"/"+"getQRcodeBCH/"+AuthToken.authtoken+"/"+AuthToken.userid,
      //"data": data
    };
        ...
        child: Column(
            ...
            children: <Widget>[
              Container(
                ...
                child: Image.asset("./assets/images/fz_bch.png",scale: 7,),
              ),
